...
def default_form_state() -> dict[str, Any]:
    return {
        ...
        "prematch_source_type": "",
        "prematch_overall_confidence": "",
        "prematch_requires_official_confirmation": False,
        "prematch_max_total_adjustment": 0.15,
        "prematch_subjective_detected": False,
        "prematch_adjustment_enabled": False,
